  ...
  return (
    <>
      ...
      <motion.button
        ...
        className="fixed bottom-8 right-8 w-16 h-16 bg-gradient-to-br from-red-600/90 to-red-700/90 hover:from-red-700 hover:to-red-800 text-white rounded-full shadow-2xl z-50 flex items-center justify-center transition-all duration-500 hover:scale-110 border border-red-500/30 relative group overflow-hidden backdrop-blur-sm"
      ...
      >
        ...
        <div className="absolute -left-2 top-1/2 transform -translate-y-1/2 w-1 h-10 bg-gradient-to-b from-transparent via-red-500/60 to-transparent rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
      </motion.button>
